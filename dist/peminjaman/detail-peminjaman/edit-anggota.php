...
if (isset($_POST['edit_anggota'])) {
    ...
    $log_aktivitas="Edit trs_pinjam anggota #$kode_anggota ";
    ...
    if ($edit_peminjaman_anggota) {
        ...
        header("Location:../../index.php?page=detail-peminjaman&kode_pinjam=$kode_pinjam&edit-anggota=berhasil");
    }
    else {
        mysqli_query($kon,"ROLLBACK");
        header("Location:../../index.php?page=detail-peminjaman&kode_pinjam=$kode_pinjam&edit-anggota=gagal");
