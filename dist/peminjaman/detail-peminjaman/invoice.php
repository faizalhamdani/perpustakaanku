<?php
    ...
    $pdf->Cell(72,6,'Judul koleksi',1,0,'C');
    ...
    if (isset($_GET['kode_pinjam']) and $_GET['kode_pinjam']!=''){
        $kode_pinjam=$_GET['kode_pinjam'];
        $sql="select * from trs_kembali inner join trs_pinjam on trs_pinjam.kode_pinjam=trs_kembali.kode_pinjam
        inner join koleksi on koleksi.kode_koleksi=trs_kembali.kode_koleksi where trs_pinjam.kode_pinjam='$kode_pinjam'";
    }else if (isset($_GET['kode_anggota'])){
        $kode_anggota=$_GET['kode_anggota'];
        $sql="select * from trs_kembali inner join trs_pinjam on trs_pinjam.kode_pinjam=trs_kembali.kode_pinjam
        inner join koleksi on koleksi.kode_koleksi=trs_kembali.kode_koleksi where kode_anggota='$kode_anggota'";
    }
    ...
    while ($data = mysqli_fetch_array($hasil)){
        ...
        //Menampilkan data
        $pdf->Cell(8,6,$no,1,0);
        $pdf->Cell(72,6,$data['judul_koleksi'],1,0);
