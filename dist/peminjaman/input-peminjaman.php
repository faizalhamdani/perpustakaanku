...
<main>
    <input type="hidden" name="kode_pinjam" value="<?php echo $kode_pinjam; ?>"/>
        <div class="container-fluid">
            <h2 class="mt-4">Input Peminjaman #<?php echo $kode_pinjam; ?></h2>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Input Peminjaman #<?php echo $kode_pinjam; ?></li>
            </ol>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php if ($max_jml_koleksi!=0){?>
                                <div class="alert alert-info">
                                    <?php echo $data1['nama_anggota'];?> saat ini sedang meminjam sebanyak <?php echo $jumlah_pinjam; ?> pustaka. Maksimal pustaka yang dapat dipinjam adalah <?php echo $max_jml_koleksi; ?>
                                </div>
                            <?php }else{ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php
                                ...
                                $hasil=mysqli_query($kon,"select max_wkt_pjm from kebijakan limit 1");
                                $data = mysqli_fetch_array($hasil); 
                                $waktu_pinjam=$data['max_wkt_pjm'];
                                $tgl=date('d-m-Y H:i');
