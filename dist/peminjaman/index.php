                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tabel_peminjaman" width="100%" cellspacing="0">
                        ...
                        <?php
                            ...
                            $sql="select p.kode_pinjam,an.nama_anggota,count(*) as jumlah_koleksi, p.tanggal
                            from trs_pinjam p
                            inner join anggota an on an.kode_anggota=p.kode_anggota
                            inner join trs_kembali dp on dp.kode_pinjam=p.kode_pinjam
                            inner join koleksi pk on pk.kode_koleksi=dp.kode_koleksi
                            group by an.nama_anggota,p.kode_pinjam
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['jumlah_koleksi']; ?> Koleksi</td>
                            <td>
                                <a href="index.php?page=detail-peminjaman&kode_pinjam=<?php echo $data['kode_pinjam']; ?>" class="btn btn-success btn-circle"><i class="fas fa-mouse-pointer"></i></a>
                                <a href="peminjaman/hapus-peminjaman.php?kode_pinjam=<?php echo $data['kode_pinjam']; ?>" class="btn-hapus-Peminjaman btn btn-danger btn-circle" ><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
