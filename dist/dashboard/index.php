    ...
    <div class="container-fluid">
        ...
        <div class="row">
             <?php 
                ...
                $hasil=mysqli_query($kon,"select kode_pinjam from trs_kembali");
            ...
            <?php 
                $hasil=mysqli_query($kon,"select kode_koleksi from koleksi");
                $jumlah_koleksi = mysqli_num_rows($hasil);
            ?>
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-dark-800"><?php echo $jumlah_koleksi;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <?php 
                ...
                $sql="select SUM(denda) as total_denda from trs_kembali";
        ...
        <div class="row">
             <?php
                ...
                include '../config/database.php';
                $sql="select p.kode_pinjam from trs_kembali d
                inner join trs_pinjam p on p.kode_pinjam=d.kode_pinjam
