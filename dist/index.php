                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    ...
                    ?>
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLaporan" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="index.php?page=laporan-koleksi"><i class="fas fa-grip-horizontal"></i> &nbsp; koleksi</a>
                                    <a class="nav-link" href="index.php?page=laporan-anggota"><i class="fas fa-user-tag"></i> &nbsp; Anggota</a>
                                </nav>
                            </div>

                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsekoleksi" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Koleksi
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapsekoleksi" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="index.php?page=koleksi"><i class="fas fa-book"></i>  &nbsp; Koleksi</a>
                                    <a class="nav-link" href="index.php?page=kategori"><i class="fas fa-grip-horizontal"></i> &nbsp; Kategori</a>
                                    <a class="nav-link" href="index.php?page=pengarang"><i class="fas fa-user-tag"></i> &nbsp; pengarang</a>
                        ...
                        <div class="nav">
                            ...
                            <!-- <a class="nav-link" href="index.php?page=koleksi">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Koleksi
                            </a> -->
                    ...
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            ...
                            case 'koleksi':
                                ...
                                break;
                            case 'pengarang':
                                include "koleksi/pengarang/index.php";
                                break;
                            case 'penerbit':
                                include "koleksi/penerbit/index.php";
                                break;
                            case 'kategori':
                                include "koleksi/kategori/index.php";
                                break;
                            ...
                            case 'laporan-peminjaman':
                                ...
                                break;
                            case 'laporan-koleksi':
                                include "laporan/koleksi/laporan-koleksi.php";
                                break;
                            ...
                            case 'pengembalian-saya':
                                include "peminjaman/anggota/pengembalian.php";
                                break;
                            case 'denda-saya':
