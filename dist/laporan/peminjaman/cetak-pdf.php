...
session_start();
    ...
    if ($_SESSION["level"]=="Admin"){
        ...
        $sql="select p.kode_pinjam,an.nama_anggota,pk.judul_koleksi,dp.tanggal_pinjam,dp.tanggal_kembali,dp.status
        from trs_pinjam p
    ...
    while ($data = mysqli_fetch_array($hasil)):
        ...
        $pdf->Cell(100,6,substr($data['judul_koleksi'],0,89),1,0);
