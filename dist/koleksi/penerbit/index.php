                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  <a href="koleksi/penerbit/hapus-penerbit.php?id_penerbit=<?php echo $data['id_penerbit']; ?>" class="btn-hapus btn btn-danger btn-circle" ><i class="fa fa-trash"></i></a>
                              </td>
                          </tr>
...
<script>
    ...
    $('.btn-tambah').on('click',function(){
        ...
        $.ajax({
            url: 'koleksi/penerbit/tambah-penerbit.php',
            method: 'post',
    ...
    $('.btn-edit').on('click',function(){
        ...
        $.ajax({
            url: 'koleksi/penerbit/edit-penerbit.php',
            method: 'post',
